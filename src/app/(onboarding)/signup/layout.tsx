  ...
  return <>
       <div className="grid grid-cols-12  h-full w-full bg-noble-black-700">
                        ...
                        <div className=" p-8 rounded-lg shadow-lg w-full max-w-4xl ">
                            <div className="flex justify-between items-center mb-16">
                                <div className="text-2xl font-bold">
                                    <img className='h-6 w-6' src="/images/onboarding/Logo.png" alt="Logo" />
                                </div>
                                <Button variant="outline" size="lg" className="border-none stem-green-500"> Log In</Button>
            ...
            <div className="col-span-5 md:col-span-5 hidden sm:block lg:col-span-4 rounded-xl overflow-auto">
                ...
                <img className="h-screen w-full object-cover rounded-4xl md:rounded-xl" src="/images/onboarding/Illustration.png" alt="Illustration" />
            </div>
        </div>
  </>;
}
